...
class ClowderRepo(object):
    ...
    def init(self, url, branch):
        ...
        repo = Git(self.clowder_path)
        repo.git_create_repo(url, 'origin', repo_branch)
        self.link()
    ...
    def is_dirty(self):
        ...
        repo = Git(self.clowder_path)
        return repo.git_is_dirty(self.clowder_path)
